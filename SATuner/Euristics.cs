...
namespace SATuner
{
    class Euristics
    {
        ...
        public static List<Plan> CompareSA(Plan P_best, Plan P_neigh, Plan P_curr, double t, int seed)
        {
            ...
            double curr_obj_norm = curr_obj - t * Math.Log(new Random(seed).NextDouble());
